...
//    return (
//    <div className="m-4">
//       <h1 className="fw-bold text-center text-danger">STUDENT INFOMATION SYSTEM</h1>
...
const App = () => {
  ...
  //onChange use for input  //they should be equal to a function
  //onSubmit use for forms //
  const [data, setData] = useState('medinat')
  ...
  return (
    <div style={{display: 'flex'}}>
      ...
      <div className="m-5 bg-primary" style={{ border: "2px", width: "600px", height:"200px" }}>
      ...
      <div className="m-5">
        <input onChange={handleUsername} value={username} className="form-control" style={{ width: "600px" }} />
        <input onChange={handleEmail} value={email} className="form-control" style={{ width: "600px" }} />
        <input onChange={handleAge} value={age} className="form-control" style={{ width: "600px" }} />
      </div>
      <button type="submit" className="btn btn-primary p-3 mt-4">Click me ....</button>
      </form> */}
       <FetchData></FetchData>
    </div>
  );
...
//         <img src={props.loadData.image} className="card-img-top" alt="..." height="300" />
//         <hr/>
//         <div className="card-body">
//           <h5 className="card-title">Name--{props.loadData.name}</h5>
//           <h5 className="card-title">Level--{props.loadData.level}</h5>
//           <hr></hr>
//           <h4>Remark</h4>
//           <p className="card-text">{props.loadData.word}</p>
...
// function Students(props) {
//   return (
//     <div className="student_card" style={{backgroundColor:"black", borderRadius: "16px"}}>
//       <div className="card m-4" style={{ width: "19rem", height: "23rem", backgroundColor:"#fff" }}>
//         <div className="card-body">
//           <h5 className="card-title">Name--{props.loadData.name}</h5>
//           <h5 className="card-title">Email--{props.loadData.email}</h5>
//           <hr></hr>
//           <h4 className="text-danger">Remark</h4>
//           <p className="card-text">{props.loadData.body}</p>
//         </div>
//       </div>
//     </div>
//   )
